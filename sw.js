          ...
          caches
            ...
            .then(function add(cache) {
              ...
              */
              ...
              // }else{
                cache.put(event.request,cacheCopy); // no need to do the condition above because the issue is patched in createGeometryButton by preloading the the html2canvas
              // }
