...
$data = mysqli_real_escape_string($conn, $_POST['name']); //// i !!!!!
}
...
//Define the table(users) , the field, and the VALUE that will be inserted
  $query = "INSERT INTO users(name) VALUES('$data')"; ///// VALUES IS THE FILE THAT WE WANT TO INSERT
// echo "<script>document.writeln(myname);</script>";

if(isset($_POST['name'])){

$comments = mysqli_real_escape_string($conn, $_POST['comment']); //// i !!!!!
}

$query .= "INSERT INTO users(comments) VALUES('comment')"; ///// VALUES IS THE FILE THAT WE WANT TO INSERT
